    ...
    <div>
        ...
        <>
          ...
          <div className={styles.loginForm}>
            ...
            <label className="flex flex-col">
              ...
              <div id="passwordError" className={styles.passwordErrorMessage}>
                {" "}
              </div>
            </label>
            <button onClick={RegistraionSend} className="authorization__btn">
              Зареєструватися
            </button>
            <br></br>
      ...
      {isRegistred && (
        <>
          ...
          <div className={styles.registredForm}>
            Був створений Ваш обліковий запис.<br></br>Тепер спробуйте{" "}
            <NavLink to="/login">увійти до системи!</NavLink>
          </div>
        </>
      )}
    </div>
