...
const AddNew = () => {
  ...
  return (
    <div className={styles.addNew}>
      <h1 className="text-center text-xl md:text-3xl my-5">
        Сторінка додавання нової публікації
      </h1>

      {!added && (
        <>
          <h3 className="text-center text-lg md:text-2xl my-4">
            Заповнюйте форму
          </h3>
          <div className={styles.addPostForm}>
            ...
            <label>
              ...
              <input
                type="text"
                placeholder="url-адреса детальної новини"
                value={link}
            ...
            <label>
              ...
              <input
                type="text"
                placeholder="url-посилання на зображення"
                value={image}
            ...
            <label>
              ...
              <div
                id="descriptionError"
                className={styles.addPostErrorMessage}
              ></div>
            </label>
            ...
            <div className="flex justify-around items-center mt-3">
              <button
                onClick={resetForm}
                className="bg-slate-400 hover:bg-slate-200  rounded-xl px-3 py-1 h-10 hover:shadow-lg"
              >
                Скинути
              </button>
              <button
                onClick={sendForm}
                className="bg-teal-500 rounded-xl px-4 py-3 hover:bg-teal-400 hover:shadow-lg"
              >
                Додати новину в БД
              </button>
            </div>
      ...
      {added && (
        <>
          ...
          <div className={styles.addPostForm}>
            ...
            <button
              onClick={addOneMore}
              className="rounded-xl bg-teal-300 px-3 py-2 hover:bg-teal-400 mt-8 mb-2 w-60 m-auto cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
