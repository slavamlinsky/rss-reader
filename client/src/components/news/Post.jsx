  ...
  return (
    <div className={styles.onePost}>
      <div className="w-full md:w-4/12 relative">
        <img
          src={image}
          className="pointer-events-none max-w-none w-full rounded-t-xl md:rounded-t-none"
          alt="logo"
        />
        <img
          src={image}
          className="hover:animate-ping-once opacity-0 md:opacity-5 absolute top-0 max-w-none w-full"
          alt="logo"
        />
      </div>
      <div className="w-full md:w-8/12 flex flex-col items-start pl-0 mt-2 md:mt-0 md:pl-5">
        <p className="text-xs font-bold text-slate-400 hover:text-slate-500">
          {postTime}, {postDate}
        </p>
        <a
