  ...
  return (
    <div className={styles.onePost}>
      <div className="w-full md:w-4/12 relative">
        <img
          src={image}
          className="pointer-events-none max-w-none w-full rounded-t-lg md:rounded-t-sm"
          alt="logo"
        />
        <img
          src={image}
          className="hover:animate-ping-once opacity-0 md:opacity-15 absolute top-0 max-w-none w-full"
          alt="logo"
        />
      </div>
      <div className="w-full md:w-8/12 flex flex-col items-start md:ml-5 mt-2 md:mt-0">
        <div className="flex flex-row justify-between w-full">
          <p className="text-xs font-normal md:font-bold text-slate-500 hover:text-slate-600">
            {postTime}, {postDate}
          </p>
          <p className="text-xs font-normal md:font-bold text-slate-500 hover:text-slate-600">
            {category[0]}
