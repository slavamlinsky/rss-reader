...
const Feed = () => {
  ...
  return (
    <div className={styles.postsFeed}>
      <h1 className={styles.header1}>Стрічка найсвіжіших новин</h1>
      ...
      <div className={styles.feedChangeBtn}>
        <button
          onClick={() =>
            setFeedLink("https://www.radiosvoboda.org/api/zrqiteuuir")
          }
        >
          RadioSvoboda
          <svg
        ...
        <button
          onClick={() =>
            setFeedLink("https://www.techradar.com/rss/news/computing")
          }
        >
          RadarTech
          <svg
        ...
        <button
          onClick={() =>
            setFeedLink(
              "https://static.censor.net/censornet/rss/rss_ru_events.xml"
            )
          }
        >
          Цензор.Нет
        ...
        <button onClick={() => setFeedLink("https://tsn.ua/rss/full.rss")}>
          ТСН
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <button
          onClick={() =>
            setFeedLink(
              "https://www.dailystar.co.uk/sport/football/?service=rss"
            )
          }
        >
          DailyStar
      ...
      {feedInfo.img && (
        <div className={styles.feedLogo}>
          <a href={feedInfo.url} target="_blank" rel="noreferrer">
            <img
              src={feedInfo.img}
